...
sudo rm -rf ${APIGEE_DRUPAL_SOURCE_ROOT_RELEASE}/vendor/bin
sudo ln -sfvn ${APIGEE_DRUPAL_SOURCE_ROOT_RELEASE}/vendor/drush/drush ${APIGEE_DRUPAL_SOURCE_ROOT_RELEASE}/vendor/bin
